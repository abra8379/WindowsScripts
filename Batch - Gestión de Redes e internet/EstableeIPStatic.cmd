:: Utilice bajo su propio riesgo. Sin garantía expresa o implícita.
:: Se concede permiso para copiar, distribuir y modificar, siempre
:: y cuando este mensaje no sea eliminado.
:: Configurar la dirección IP estática y reemplace el sitio web por https://elendill.wordpress.com/
@Echo OFF 
...
:QUIT 
msg * La dirección IP ahora es estatica.
msg * https://elendill.wordpress.com/
exit
pause>nul